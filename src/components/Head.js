  ...
  return (
    <div className="grid grid-flow-col m-1 p-1 shadow-lg">
      <div className="flex col-span-1">
        <img
          className="m-4 h-8 cursor-pointer"
      ...
      <div className="col-span-10 my-5 text-center">
        <div>
          <input
            className="w-1/2 border text-left border-gray-400 p-2 rounded-l-full rounded-md pl-3 pr-28 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
            type="text"
            placeholder="Search"
            value={searchQuery}
        ...
        {showSearchSuggestions && (
          <div className="ml-[14rem] bg-white fixed z-20 text-left py-2 px-2 shadow-xl rounded-lg w-[32rem] border border-gray-100 ">
            <ul>
      ...
      <div>
        <img
          className="h-10 mt-4 col-span-1"
          alt="user"
